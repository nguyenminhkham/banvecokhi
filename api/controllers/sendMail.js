...
const oauth2Client = new google.auth.OAuth2(
    ...
    const mailOptions = {
        ...
        html: `
            ...
            <h2 style="text-align: center; text-transform: uppercase;color: #01bf71;">Chào mừng bạn đến với Tmaster</h2>
            <p>Xin chúc mừng! Bạn sẽ sẵn sàng tạo tài khoản tại TMASTER sau một vài thao tác.
                Chỉ cần kích vào nút xác nhận bên dưới.
            </p>

            <a href=${url} style="background: #cb2026; text-decoration: none; color: white; padding: 10px 20px; margin: 10px 0; display: inline-block;">${txt}</a>
