...
const productCtrl = {
    ...
    addusers: expressAsyncHandler(async (req, res) => {
        try {
    ...
    deleteusers: expressAsyncHandler(async (req, res) => {
        try {
    ...
    downloads: expressAsyncHandler(async (req, res) => {
        try {
            let product
